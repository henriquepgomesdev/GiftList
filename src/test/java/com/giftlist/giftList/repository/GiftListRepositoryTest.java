...
@ActiveProfiles("test")
@Transactional
public class GiftListRepositoryTest {
    ...
    public void testSearch() {
        ...
        int expectedSize = 1;
        String message = String.format("Deveria encontrar %s de presente", expectedSize);
        assertEquals(message, expectedSize, giftLists.size());
    }
